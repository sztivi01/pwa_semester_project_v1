            ...
            <div className="flex justify-center items-center h-full" > 
                <form onSubmit={handleSubmit} className='max-w-[450px] w-full mx-auto my-20 bg-white p-8'>
                    ...
                    <div className='flex flex-col mb-4'>
                        ...
                        <input className='border border-indigo-600 rounded-lg relative  p-2' type="text" value={firstName} onChange={(e) => setfirstName(e.target.value)}/>
                    </div>
                    <div className='flex flex-col mb-4'>
                        <label className='flex item-center'><FaUserAlt className='ml-1 mr-2 mt-1'/>Last Name</label>
                        <input className='border border-indigo-600 rounded-lg relative  p-2' type="text"value= {lastName} onChange={(e) => setlastName(e.target.value)} />
                    </div>
                    <div className='flex flex-col mb-4'>
                        <label className='flex item-center'><MdEmail className='ml-1 mr-2 mt-1'/>Email</label>
                        <input className='border border-indigo-600 rounded-lg relative  p-2' type="text" value={username} onChange={(e) => setUserName(e.target.value)}/>
                    </div>
                    <div className='flex flex-col mb-4'>
